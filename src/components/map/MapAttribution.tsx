    ...
    <>
      ...
      <div className="absolute bottom-0 right-0 p-2 bg-white/80 backdrop-blur-sm rounded-tl m-2 shadow-sm">
        <div className="text-xs flex flex-wrap gap-x-2">
          <a href="https://mausam.imd.gov.in/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Weather Services</a>
          <a href="https://cwc.gov.in/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Water Commission</a>
          <a href="https://ndma.gov.in/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Disaster Management</a>
        </div>
      </div>
    </>
  );
